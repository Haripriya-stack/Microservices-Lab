...
namespace Mango.Web.Services
{
    public class CouponService : ICouponService
    {
        ...
        public async Task<ResponseDTO> GetAllCouponsAsync()
        {
            ...
            req.Url = APIType.APIBaseUrl+"/api/CouponAPI/";
        ...
        {
            RequestDTO req = new RequestDTO();
            req.Url = APIType.APIBaseUrl + "/api/CouponAPI/GetByCode/"+code;
            req.ApiTypeMethod = APIType.APITypeEnum.GET;
            req.ContentType = "application/json";
        ...
        {
            RequestDTO req = new RequestDTO();
            req.Url = APIType.APIBaseUrl + "/api/CouponAPI/GetById/" + id;
            req.ApiTypeMethod = APIType.APITypeEnum.GET;
            req.ContentType = "application/json";
        ...
        public async Task<ResponseDTO> PostCouponDataAsync(CouponDTO couponData)
        {
            ...
            RequestDTO req = new RequestDTO();
            req.Url = APIType.APIBaseUrl + "/api/CouponAPI/postcoupon/";
        ...
        {
            RequestDTO req = new RequestDTO();
            req.Url = APIType.APIBaseUrl + "/api/CouponAPI/updatecoupon/";
        ...
        {
            RequestDTO req = new RequestDTO();
            req.Url = APIType.APIBaseUrl + "/api/CouponAPI/deletecoupon/" + id;
